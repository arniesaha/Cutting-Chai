...
public class PhotoUtils {
	...
	private static final String API_KEY_VALUE = "d648d6845825ec6988f4e18d2e19f6f6";
	private static final String BASE_URL = "https://api.flickr.com/services/rest/?method=flickr.photos.search&content_type=1&media=photos&nojsoncallback=1&tags=photo,audio,compass";
	public static final String AC_URL = "https://api.flickr.com/services/rest/?method=flickr.groups.pools.getPhotos&" + "api_key=" + API_KEY_VALUE+"&group_id=831336@N21" +  "&format=json&nojsoncallback=1&"
